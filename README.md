...
<p align="center">
    <a href="https://kitura-next.github.io/Kitura-CORS/index.html">
    <img src="https://img.shields.io/badge/apidoc-KituraCORS-1FBCE4.svg?style=flat" alt="APIDoc">
    </a>
    <a href="https://travis-ci.org/Kitura-Next/Kitura-CORS">
    <img src="https://travis-ci.org/Kitura-Next/Kitura-CORS.svg?branch=master" alt="Build Status - Master">
    </a>
...
Add the `Kitura-CORS` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `Kitura-CORS` [release](https://github.com/Kitura-Next/Kitura-CORS/releases).

```swift
.package(url: "https://github.com/Kitura-Next/Kitura-CORS.git", from: "x.x.x")
```
...
Kitura-CORS implements the [RouterMiddleware](https://kitura-next.github.io/Kitura/Protocols/RouterMiddleware.html) protocol; therefore to connect the middleware to your path you need to use one of the `Router` methods, for example:
...
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Kitura-CORS/index.html).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/Kitura-CORS/blob/master/LICENSE.txt).
